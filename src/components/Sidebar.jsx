...
const NAV = [
  ...
  { id:'pos',        label:'Point of Sale',icon: <PosIcon />,   badge:null },
    ...
    <aside style={{
      ...
      <nav style={{ flex:1, overflowY:'auto', overflowX:'hidden', padding:'12px 8px' }}>
        {NAV.map((item, i) => {
          ...
          const clickable = ['dashboard','shipments','quotes','carriers','calculator','webhooks'].includes(item.id)
...
function ShipIcon() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>
}
function QuoteIcon() {
...
function CarrierIcon() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 17H5a2 2 0 0 0-2 2"/><path d="M15 17h4a2 2 0 0 1 2 2"/><path d="M12 17V3"/><path d="m8 7-4 4 4 4"/><path d="m16 7 4 4-4 4"/></svg>
}
function CalcIcon() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="8" y1="10" x2="10" y2="10"/><line x1="14" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="10" y2="14"/><line x1="14" y1="14" x2="16" y2="14"/><line x1="8" y1="18" x2="16" y2="18"/></svg>
}
function WebhookIcon() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 16.98h-5.99c-1.1 0-1.95.68-2.23 1.61"/><circle cx="9" cy="22" r="2"/><path d="M9 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path d="M9 12v3.99"/><path d="M15 9.4a6.5 6.5 0 0 1 .24 9.5"/></svg>
}
function BroadIcon() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07"/><path d="M11 11a5 5 0 0 1 7.54.54l3-3a17 17 0 0 0-18.09-.98"/><polyline points="1 1 23 23"/></svg>
}
function RefIcon() {
